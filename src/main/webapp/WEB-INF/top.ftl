<HTML><HEAD>
    ...
    <script>
        function modifypsw(){
            var dw=window.showModalDialog('uiAction_staff_updPwd','', 'dialogHeight:180px; dialogWidth:260px; dialogLeft:500px; dialogTop:220px;edge:sunken;center:yes;location:no;help:no;resizable:no;status:no;scroll:no');
        }
    </script>

</HEAD>
<BODY bgColor=#3CCBD8 leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
                                    ...
                                    <div align="right">
                                        <table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
                                            <tr>
                                                ...
                                                <td width="55" valign="middle"><a href="staff/staffAction_logout" target="_top"><font color="ffffff">重新登录</font></a></td>
                                            </tr>
                                        </table>
                                    </div>
                                </td>
